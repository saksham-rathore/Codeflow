...
- **Background AI agent pipeline** — multi-step AI tasks run through [Inngest](https://www.inngest.com/), off the UI thread.
- **Web-aware AI** — [Firecrawl](https://www.firecrawl.dev/) lets the assistant pull in live web content.
- **Auth** — [Clerk](https://clerk.com/), wired into Convex for authenticated real-time data.
- **Error monitoring** — [Sentry](https://sentry.io/) across edge, server, and client.
...
| UI | Radix, shadcn, `cmdk`, `allotment`, Lucide/Hugeicons |
...
>>>>>>> 2f99a6e230da2b3d888337ae200cbc2569cf5e7d
